                    ...
                    <form class="form-horizontal" role="form"  ng-submit="loginAction(login)" name="login"  >
                        ...
                        <div style="margin-bottom: 25px" class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>                            
                                <input ng-model="login.email" type="text"  id="inputEmail1" class="form-control" placeholder="Usuario" required="" autofocus="">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12 control">
                                <div style="border-top: 1px solid #FFAAAA; padding-top:15px; font-size:85%" >
                                    No tengo una cuenta! 
                                    <a href="index.php?ctl=registro" ><!--onClick="$('#loginbox').hide(); $('#signupbox').show()"-->
